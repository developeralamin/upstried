...
import { TipsLinkAndAttachUploaderProps } from './TipsLinkAndAttachUploader.d';

const TipsLinkAndAttachUploader: React.FC<TipsLinkAndAttachUploaderProps> = (
  props
) => {
  ...
  const onDone = (attachments: Array<LinkAttachInterface>) => {
  ...
  return (
    <div className={clsx(styles.TipsLinkAndAttachUploader, 'TipsLinkAndAttachUploader')}>
      <div className={styles.Actions}>
        ...
        <Modal
          ...
          visible={linkModal}
        >
          <LinkModal onChange={onDone} onCloseModal={onCloseModal} />
        </Modal>
      </div>
    </div>
  );
...
export default TipsLinkAndAttachUploader;
